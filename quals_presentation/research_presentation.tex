...
High-level software could provide this safe corridor and goals (``drive at this speed", ``stop at this point"). The exact path is determined by the steering controller.
...
\vspace{-0.5em}
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/division.png}
\end{figure}
\end{frame}
...
\vspace{-0.5em}
\begin{figure}
	\includegraphics[width=0.6\linewidth]{figures/centering_issue.png}
\end{figure}
\vspace{-0.5em}
...
\vspace{-0.5em}
\begin{figure}
	\includegraphics[width=0.8\linewidth]{figures/steering_angle_cg.png}
\end{figure}
\vspace{-0.5em}
